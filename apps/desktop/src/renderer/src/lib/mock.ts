...
export const mockApi: SparkyApi = {
  system: {
    info: async () => ({
      ...
      tools: [
        { id: 'ffmpeg', label: 'FFmpeg', found: true, version: '7.1', optional: false },
        { id: 'ffprobe', label: 'FFprobe', found: true, version: '7.1', optional: false },
        { id: 'yt-dlp', label: 'yt-dlp', found: true, version: '2026.08.19', optional: false },
        { id: 'pandoc', label: 'Pandoc', found: true, version: '3.9', optional: false },
        { id: '7zip', label: '7-Zip', found: true, version: '25.01', optional: false },
        { id: 'deno', label: 'Deno (helps yt-dlp with YouTube)', found: true, version: '2.5.1', optional: true },
        { id: 'ghostscript', label: 'Ghostscript (shrinks PDFs)', found: false, optional: true },
        { id: 'libreoffice', label: 'LibreOffice (better Word → PDF)', found: false, optional: true },
      ],
    }),
  },
  files: {
